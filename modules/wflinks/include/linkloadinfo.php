...
$link['country'] = XOOPS_URL . "/uploads/flags/flags_small/" . $country. ".gif";
...
$link['mail_body'] = rawurlencode( sprintf( _MD_WFL_INTFILEFOUND, $xoopsConfig['sitename'] ) . ':  ' . XOOPS_URL . '/modules/' . $xoopsModule -> getVar( 'dirname' ) . '/singlelink.php?cid=' . $link_arr['cid'] . '&amp;lid=' . $link_arr['lid'] );
...
$link['allow_rating'] = ( checkgroups( $cid, 'WFLinkRatePerms' ) ) ? true : false;
