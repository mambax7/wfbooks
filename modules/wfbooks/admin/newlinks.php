...
switch ( strtolower( $op ) ) {
    case "approve":
        ...
        global $xoopsModule;
        $sql = "SELECT cid, title, notifypub FROM " . $xoopsDB -> prefix( 'wfbooks_links' ) . " WHERE lid=" . $lid;
        ...
        $xoopsDB -> queryF( "UPDATE " . $xoopsDB -> prefix( 'wfbooks_links' ) . " SET published='$time.', status='1', publisher='$publisher' WHERE lid=" . $lid );
        ...
        redirect_header( 'newlinks.php', 1, _AM_WFB_SUB_NEWFILECREATED );
        break;
    ...
    default:
        ...
        xoops_cp_header();
        wfl_adminmenu( _AM_WFB_SUB_SUBMITTEDFILES );

        echo "<fieldset><legend style='font-weight: bold; color: #0A3760;'>" . _AM_WFB_SUB_FILESWAITINGINFO . "</legend>\n";
        echo "<div style='padding: 8px;'>" . _AM_WFB_SUB_FILESWAITINGVALIDATION . "&nbsp;<b>$new_array_count</b><div>\n";
        echo "<div div style='padding: 8px;'>\n";
        echo "<li>" . $imagearray['approve'] . " " . _AM_WFB_SUB_APPROVEWAITINGFILE . "\n";
        echo "<li>" . $imagearray['editimg'] . " " . _AM_WFB_SUB_EDITWAITINGFILE . "\n";
        echo "<li>" . $imagearray['deleteimg'] . " " . _AM_WFB_SUB_DELETEWAITINGFILE . "</div>\n";
        echo "</fieldset><br />\n";

        echo "<table width='100%' cellspacing='1' class='outer'>\n";
        echo "<tr style='text-align: center;'>\n";
        echo "<th width='3%'>" . _AM_WFB_MINDEX_ID . "</th>\n";
        echo "<th style='text-align: left;' width='30%'>" . _AM_WFB_MINDEX_TITLE . "</th>\n";
        echo "<th width='15%'>" . _AM_WFB_MINDEX_POSTER . "</th>\n";
        echo "<th width='15%'>" . _AM_WFB_MINDEX_SUBMITTED . "</th>\n";
        echo "<th width='7%'>" . _AM_WFB_MINDEX_ACTION . "</th>\n";
        echo "</tr>\n";
        if ( $new_array_count > 0 ) {
            ...
            echo "<tr><td style='text-align: center;' class='head' colspan='6'>" . _AM_WFB_SUB_NOFILESWAITING . "</td></tr>";
        } 
        echo "</table>\n";

        include_once XOOPS_ROOT_PATH . '/class/pagenav.php';
        $page = ( $new_array_count > $xoopsModuleConfig['admin_perpage'] ) ? _AM_WFB_MINDEX_PAGE : '';
