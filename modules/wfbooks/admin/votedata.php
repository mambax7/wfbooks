...
switch ( strtolower($op) ) {
    case "delvote":
        ...
        redirect_header( "votedata.php", 1, _AM_WFB_VOTEDELETED );
        break;
	...
	$start = wfl_cleanRequestVars( $_REQUEST, 'start', 0 );
        xoops_cp_header();
        wfl_adminmenu( _AM_WFB_VOTE_RATINGINFOMATION );
		...
		<tr>\n
		<th style='text-align: center;'>" . _AM_WFB_VOTE_ID . "</th>\n
		<th style='text-align: center;'>" . _AM_WFB_VOTE_USER . "</th>\n
		<th style='text-align: center;'>" . _AM_WFB_VOTE_IP . "</th>\n
		<th style='text-align: center;'>" . _AM_WFB_VOTE_FILETITLE . "</th>\n
		<th style='text-align: center;'>" . _AM_WFB_VOTE_RATING . "</th>\n
		<th style='text-align: center;'>" . _AM_WFB_VOTE_DATE . "</th>\n
		<th style='text-align: center;'>" . _AM_WFB_MINDEX_ACTION . "</th></tr>\n";

        $sql = "SELECT * FROM " . $xoopsDB -> prefix( 'wfbooks_votedata' );
        if ( $lid > 0 ) {
            $sql .= " WHERE lid=" . $lid;
        } 
        ...
        if ( $votes == 0 ) {
            echo "<tr><td style='text-align: center;' colspan='7' class='head'>" . _AM_WFB_VOTE_NOVOTES . "</td></tr>";
        } else {
        ...
        $page = ( $votes > $xoopsModuleConfig['admin_perpage'] ) ? _AM_WFB_MINDEX_PAGE : '';
