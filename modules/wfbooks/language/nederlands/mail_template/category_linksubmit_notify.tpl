...
Een nieuw boek "{LINK_NAME}" is ingezonden in de categorie "{CATEGORY_NAME}" op {X_SITENAME} en wacht op goedkeuring.

U kunt de ingezonden vermelding bekijken via de onderstaande link (NB: deze pagina toont alle wachtende boeken in alle categoriën):
